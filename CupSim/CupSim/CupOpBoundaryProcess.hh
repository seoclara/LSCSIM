...
//
//
// $Id: CupOpBoundaryProcess.hh 104458 2017-05-31 15:54:11Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
#ifndef CupOpBoundaryProcess_h
#define CupOpBoundaryProcess_h 1
...
enum CupOpBoundaryProcessStatus {  Undefined,
...
class CupOpBoundaryProcess : public G4VDiscreteProcess
{
...
public:
        ...
        CupOpBoundaryProcess(const G4String& processName = "OpBoundary",
                                     G4ProcessType type = fOptical);
        ~CupOpBoundaryProcess();

private:

        CupOpBoundaryProcess(const CupOpBoundaryProcess &right);
...
public:
	...
	////////////
        ...
        CupOpBoundaryProcessStatus GetStatus() const;
...
private:
        ...
        CupOpBoundaryProcessStatus theStatus;
...
inline
G4bool CupOpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool CupOpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
                                                       aParticleType)
{
...
inline
CupOpBoundaryProcessStatus CupOpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void CupOpBoundaryProcess::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
}

inline
void CupOpBoundaryProcess::ChooseReflection()
{
...
inline
void CupOpBoundaryProcess::DoAbsorption()
{
...
inline
void CupOpBoundaryProcess::DoReflection()
{
