...
#ifndef __CupPMTOpticalModel_hh__
#define __CupPMTOpticalModel_hh__
...
class CupPMTOpticalModel : public G4VFastSimulationModel, public G4UImessenger {
  public:
    //-------------------------
    // Constructor, destructor
    //-------------------------
    CupPMTOpticalModel(G4String, G4VPhysicalVolume *);
    // Note: There is no CupPMTOpticalModel(G4String) constructor.
    ~CupPMTOpticalModel();
