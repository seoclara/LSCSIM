...
// class CupEllipsoid
//
// A CupEllipsoid is an ellipsoidal solid, optionally cut at a given z.
//
// Member Data:
//
//	fRx	semi-axis, x
...
#ifndef CupEllipsoid_HH
#define CupEllipsoid_HH

#include "G4CSGSolid.hh"
#include "G4Version.hh"

class CupEllipsoid : public G4CSGSolid {
  public:
    CupEllipsoid(const G4String &pName, G4double pRx, G4double pRy, G4double pRz, G4double pZCut1,
                 G4double pZCut2);

    virtual ~CupEllipsoid();
    ...
    virtual G4GeometryType GetEntityType() const { return G4String("CupEllipsoid"); }
  ...
  private:
    G4double fRx, fRy, fRz, fRmax, fZCut1, fZCut2;
