...
// CupOpBoundaryProcess::operator=(const CupOpBoundaryProcess &right)
// {
// }
...
CupOpBoundaryProcess::CupOpBoundaryProcess(const G4String& processName,
                                               G4ProcessType type)
...
// CupOpBoundaryProcess::CupOpBoundaryProcess(const CupOpBoundaryProcess &right)
// {
// }
...
CupOpBoundaryProcess::~CupOpBoundaryProcess(){}
...
G4VParticleChange*
CupOpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
        theStatus = Undefined;
        ...
        else 
        {
          ...
          ed << " CupOpBoundaryProcess/PostStepDoIt(): "
                 << " The Navigator reports that it returned an invalid normal"
                 << G4endl;
          G4Exception("CupOpBoundaryProcess::PostStepDoIt", "OpBoun01",
        ...
        if (OldMomentum * theGlobalNormal > 0.0) {
           ...
           ed << G4endl;
           G4Exception("CupOpBoundaryProcess::PostStepDoIt", "OpBoun02",
	...
	if (type == dielectric_metal) {
	   ...
	   // EJ corrected: kGROUPVEL is not defined yet
	   if (groupvel) {
...
void CupOpBoundaryProcess::BoundaryProcessVerbose() const
{
...
G4ThreeVector
CupOpBoundaryProcess::GetFacetNormal(const G4ThreeVector& Momentum,
...
void CupOpBoundaryProcess::DielectricMetal()
{
        G4int n = 0;
...
void CupOpBoundaryProcess::DielectricLUT()
{
        ...
        theStatus = CupOpBoundaryProcessStatus(G4int(theFinish) + 
...
void CupOpBoundaryProcess::DielectricLUTDAVIS()
{
...
void CupOpBoundaryProcess::DielectricDichroic()
{
        // Calculate Angle between Normal and Photon Momentum
...
//                   << std::floor(theTransmittance/perCent) << "%" << G4endl;
           ...
           G4ExceptionDescription ed;
           ed << " CupOpBoundaryProcess/DielectricDichroic(): "
              << " The dichroic surface has no G4Physics2DVector"
              << G4endl;
           G4Exception("CupOpBoundaryProcess::DielectricDichroic", "OpBoun03",
                       FatalException,ed,
...
void CupOpBoundaryProcess::DielectricDielectric()
{
        G4bool Inside = false;
        G4bool Swap = false;
...
// ---------------
//
G4double CupOpBoundaryProcess::GetMeanFreePath(const G4Track& ,
                                              G4double ,
...
G4double CupOpBoundaryProcess::GetIncidentAngle() 
{
...
G4double CupOpBoundaryProcess::GetReflectivity(G4double E1_perp,
                                              G4double E1_parl,
...
void CupOpBoundaryProcess::CalculateReflectivity()
{
  G4double RealRindex =
...
G4bool CupOpBoundaryProcess::InvokeSD(const G4Step* pStep)
{
  G4Step aStep = *pStep;
