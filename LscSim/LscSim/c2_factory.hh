 ...
 */
//
// $Id: c2_factory.hh,v 1.1 2017/09/29 04:48:03 ejjeon Exp $
...
/// top of a file, and used everywhere inside, or even instantiated in your project's top-level
/// include file. \see c2_math_factory \ingroup factories
...
class c2_factory {
  public:
    ...
    /// make a *new object
    static c2_connector_function_p<float_type> &
        connector_function(float_type x0, float_type y0, float_type yp0, float_type ypp0,
